...
import 'package:streamingapp/HomePage/presentation/widgets/top-streams-header.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          AnimatedSize(
            ...
            curve: Curves
                .easeInOutCubic, // شكل حركة الأنيميشن (ناعم في الأول والآخر)
            ...
            child: ListView.builder(
              ...
              itemCount: !isExpanded
                  ? 6
                  : ListViewOfTopStreams.topStreams.length,
